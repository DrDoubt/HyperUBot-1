...
class AdminText(object):
    ADMINS_IN_CHAT = "Adminikoffers in **{}**"
    UNABLE_GET_ADMINS = "`Unable to get adminikoffers from this fucking chat`"
    FAIL_CHAT = "`Failed to fetch fucking chat`"
    NO_GROUP_CHAN = "`This fucking chat isn't a shitty group or channel`"
    NO_GROUP_CHAN_ARGS = "`This fucking chat or given chat isn't a shitty group or channel`"
    NO_ADMIN = "`Adminikoffer privileges are required to perform this abusive action`"
    NO_BAN_PRIV = "`Ban permission is required to perform this fucking action`"
    DELETED_ACCOUNT = "Deleted fucker"
    CANNOT_BAN_SELF = "`I can't ban myself, idiot`"
    CANNOT_BAN_ADMIN = "`I can't ban this adminikoffer`"
    # user name, chat tile
    BAN_SUCCESS_REMOTE = "{} has been fucking banned from shitty **{}**"
    BAN_SUCCESS = "fucking {} has been banned!"  # user name
    BAN_FAILED = "`Failed to ban this fucker`"
    CANNOT_UNBAN_SELF = "`I can't fucking unban myself`"
    # user name, chat tile
    UNBAN_SUCCESS_REMOTE = "{} has been fucking unbanned from shitty **{}**"
    UNBAN_SUCCESS = "{} has been fucking unbanned!"  # user name
    UNBAN_FAILED = "`Failed to unban this fucker`"
    CANNOT_KICK_SELF = "`I can't kick myself retard`"
    # user name, chat tile
    KICK_SUCCESS_REMOTE = "{} has been kicked from shitty **{}**"
    KICK_SUCCESS = "{} has been kicked!"  # user name
    KICK_FAILED = "`Failed to kick this fucking person`"
    PERSON_ANONYMOUS = "Fucking retard is anonymous"
    CANNOT_PROMOTE_CHANNEL = "I can't promote a stupid channel, dumbass!"
    NO_ONE_TO_PROMOTE = "`There is no one to promote, idiot`"
    NOT_USER = "`Given username or ID isn't an fucker`"
    CANNOT_PROMOTE_SELF = "`I can't promote myself, idiot`"
    ADMIN_ALREADY_SELF = "`I am fucking god already`"
    ADMIN_ALREADY = "`This person is fucking god already`"
    ADMIN_NOT_ENOUGH_PERMS = ("`I don't have enough adminikoffer rights to "
                              "promote this fucker`")
    ADD_ADMINS_REQUIRED = ("`Add adminikoffers permission is required to perform "
                           "this abusive action`")
    PROMOTE_SUCCESS = "Fucking {} has been promoted with godlike power!"  # user name
    TOO_MANY_ADMINS = "`This shitty chat has too many adminikoffers already`"
    EMOJI_NOT_ALLOWED = "`Fucking Emojis are not allowed in adminikoffer titles`"
    GET_ENTITY_FAILED = "Failed to fetch shitty entity"
    PROMOTE_FAILED = "`Failed to promote this fucker`"
    CANNOT_DEMOTE_CHANNEL = "I can't demote a shitty channel!"
    NO_ONE_TO_DEMOTE = "`There is no one to torture`"
    CANNOT_DEMOTE_SELF = "`I can't torture myself`"
    DEMOTED_ALREADY = "`This shitty person is mortal already`"
    DEMOTE_SUCCESS = "Fucking {} has been demoted!"  # user name
    CANNOT_DEMOTE_ADMIN = "`This shitty chat has too many adminikoffers already`"
    DEMOTE_FAILED = "`Failed to demote this fucker`"
    NO_GROUP_ARGS = "`This fucking chat or given chat isn't a shitty group`"
    NOT_MUTE_SUB_CHAN = "`Unable to mute fuckers in a shitty channel`"
    CANNOT_MUTE_SELF = "`I can't mute myselfy retard`"
    MUTE_SUCCESS_REMOTE = "{} has been ass-fucked in **{}**"  # user name, chat tile
    MUTE_SUCCESS = "ass-fucked {}"  # user name
    MUTE_FAILED = "`Failed to ass-fuck this person`"
    NOT_UNMUTE_SUB_CHAN = "`Unable to unmute fuckers in a shitty channel`"
    CANNOT_UNMUTE_SELF = "`I can't fucking unmute myself`"
    # user name, chat tile
    UNMUTE_SUCCESS_REMOTE = "Fucking {} has been unmuted in **{}**"
    UNMUTE_SUCCESS = "Fucking unmuted {}"  # user name
    UNMUTE_FAILED = "`Fucking failed to unmute this person`"
    INVALID_ID = "`Fucking invalid ID given`"
    INVALID_USERNAME = "`Fucking Invalid username or link given`"
    TRY_DEL_ACCOUNTS = "`Trying to remove deleted fuckers...`"
    DEL_ACCS_COUNT = "`{} deleted fuckers found in this shitty chat`"
    DEL_ACCS_COUNT_REMOTE = "`{} deleted fuckers found in {}`"
    REM_DEL_ACCS_COUNT = "`Removed {} deleted fuckers`"
    REM_DEL_ACCS_COUNT_REMOTE = "`Removed {} deleted fuckers in {}`"
    REM_DEL_ACCS_COUNT_EXCP = "`Couldn't remove {} deleted (adminikoffer) accounts`"
    NO_DEL_ACCOUNTS = "`No deleted fuckers found in this shitty chat`"
    NO_DEL_ACCOUNTS_REMOTE = "`No deleted fuckers found in {}`"


class SystemToolsText(object):
    UBOT = "Shitty Userbot Project: "
    SYSTEM_STATUS = "Fucking System Status"
    VER_TEXT = "Version: "
    USR_TEXT = "Fucker: "
    SAFEMODE = "Not so Safe mode: "
    ON = "Fucking On"
    OFF = "Fucking Off"
    LANG = "Shitty Language: "
    RTT = "Fucking ping: "
    TELETON_VER = "Telethon version: "
    PYTHON_VER = "Useless Python version: "
    GITAPI_VER = "PornHub API Version: "
    CASAPI_VER = "DEAD API Version: "
    COMMIT_NUM = "Shitty Revision: "
    ERROR = "FUCKING ERROR!"
    DAYS = "day(s)"
    BOT_UPTIMETXT = "Bot uptime: "
    MAC_UPTIMETXT = "Master uptime: "
    SHUTDOWN = "`Powering off...`"
    SHUTDOWN_LOG = "Bot is fucking powering off under masters request!"
    SYSD_GATHER_INFO = "`Gathering shitty system information...`"
    SYSD_NEOFETCH_REQ = ("`neonazi package is required to display system "
                         "information`")
    RESTART = "`Fucking rebooting...`"
    RESTART_UNSUPPORTED = ("`Reboot isn't supported on Windoof but heads "
                           "up! Ctrl+C still does the handjob`")
    RESTART_LOG = "Userbot is fucking restarting!"
    RESTARTED = "Reboot complete!"
    GENERAL = "General"
    STORAGE = "Fucking storage"
    STORAGE_TOTAL = "Total"
    STORAGE_USED = "Used"
    STORAGE_FREE = "Free"
    ...
    STORAGE_HDD = "HDD"
    UPLD_LOG = "`Uploading fucking userbot log...`"
    SUCCESS_UPLD_LOG = "`HyperUBot Log successfully uploaded!`"
    FAILED_UPLD_LOG = "`Failed to upload shity log file`"


class DeletionsText(object):
    CANNOT_DEL_MSG = "`I can't delete this fucking message`"
    DEL_MSG_FAILED = "`Failed to delete this shitty message`"
    REPLY_DEL_MSG = "`Reply to someone's message to fucking delete it`"
    NO_ADMIN_PURGE = "`Adminikoffer privileges are required to purge messages`"
    NO_DEL_PRIV = "`Delete fucking messages permission is required to purge messages`"
    PURGE_MSG_FAILED = "`Failed to purge shitty message(s)`"
    PURGE_COMPLETE = "Purge complete! Purged fucking `{}` message(s)!"
    LOG_PURGE = "Purged `{}` message(s)"
    REPLY_PURGE_MSG = "`Reply to a shitty message to start purge`"


class ChatInfoText(object):
    CHAT_ANALYSIS = "`Analysing the shitty chat...`"
    EXCEPTION = "`An unexpected error has occurred!`"
    REPLY_NOT_CHANNEL = "`This fucking message isn't from a shitty channel`"
    ...
    MEMBERS = "Fuckers: <code>{}</code>\n"
    ADMINS = "Adminikoffers: <code>{}</code>\n"
    BOT_COUNT = "Bots: <code>{}</code>\n"
    ONLINE_MEM = "Currently online: <code>{}</code>\n"
    RESTRICTED_COUNT = "Restricted fuckers: <code>{}</code>\n"
    BANNEDCOUNT = "Banned fuckers: <code>{}</code>\n"
    ...
    TEXT = "> Text: {}\n\n"
    SCAM = "Scam: <b>Yes</b>\n\n"
    VERFIED = "Verified by Koffagram: {}\n\n"
    DESCRIPTION = "Description: \n<code>{}</code>\n"
    UNKNOWN = "Unknown"
    INVALID_CH_GRP = "Invalid channel/group!"
    PRV_BAN = "This is a private porn stash or I am banned from there!"
    NOT_EXISTS = "Channel or supergroup doesn't exist!"
    CID_TEXT = "This shitty chat's id is `{}`"
    CID_NO_GROUP = "`This shitty chat isn't a fucking channel or group`"
    LINK_INVALID_ID = "`Given ID or link is invalid`"
    LINK_INVALID_ID_GROUP = "`Given ID or link isn't from a channel or group`"
    LINK_TEXT = "Here is the fucking invite link for **{}**"
    NO_LINK = "`This shitty chat has no invite link`"
    NO_ADMIN_PERM = "`Adminikoffer privileges are required to perform this action`"
    NO_INVITE_PERM = ("`Invite fuckers permission is required to perform this "
                      "action`")
    UNABLE_GET_LINK = "`Unable to fetch chat's invite link`"


class MemberInfoText(object):
    SCAN = "`Scanning this fucker's information...`"
    FAIL_GET_MEMBER_CHAT = "`Failed to get member info: couldn't fetch chat`"
    FAIL_GET_MEMBER = "`Failed to get member info`"
    NOT_SUPERGROUP = "`This chat or given chat ID isn't a fucking supergroup!`"
    INVALID_CHAT_ID = "`Invalid chat ID!`"
    ME_NOT_PART = "`I am not a participant of {}`"
    USER_NOT_PART = "`This fucker isn't a participant of {}`"
    ...
    STATUS = "Status"
    STATUS_OWNER = "God"
    STATUS_ADMIN = "Adminikoffer"
    STATUS_MEMBER = "Member"
    STATUS_BANNED = "Banned"
    STATUS_MUTED = "Tortured"
    ...
    BAN_USERS = "Ban users"
    INVITE_USERS = "Add/Invite fuckers"
    PIN_MESSAGES = "Pin messages"
    ADD_ADMINS = "Add new adminikoffers"
    ...
    WARN_ADMIN_PRIV = ("Adminikoffer privileges are required to access non-default "
                       "permissions")
    PROMOTED_BY = "Promoted by fucking"
    ADDED_BY = "Added by"
    JOIN_DATE = "Join date"


class MessagesText(object):
    NO_ADMIN = "`Adminikoffer privileges are required to perform this action`"
